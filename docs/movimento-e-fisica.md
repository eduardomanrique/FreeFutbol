...
O atrito agora dissipa também a rotação física residual da bola; abaixo do limiar de repouso, velocidades linear e angular são zeradas juntas. A curva atual é (9 +36×carga^0,75 +embalo) vezes o fator angular0,60–0,15. A calibração anterior usava9 +36×carga^1,1 até45m/s; as medições históricas abaixo não representam a força atual. Na calibração anterior de17/09, testes com chutes de carga0%,10% e25% pararam após aproximadamente 13,8, 23,7 e 43,7 metros e não se moveram novamente nos dez segundos simulados sem interferência. Chutes fortes ainda podem sair antes de parar.
...
## Disputa de posse — 19/09/2026

Bola com portador usa alcance automático curto de0,70m no presente, altura até0,50m e contato de pé abaixo de0,22m; não usa a previsão de recepção de bola livre. A barreira corporal tem margem de0,50m e impede coleta atravessando o portador. Disputa por0,22s e vantagem de proximidade continuam obrigatórias. Tentativas descartam a categoria anterior quando o dono muda. Os107 testes e os cenários de proteção/fuga/passe no navegador passaram; valores e limites em [regras-da-mecanica.md](regras-da-mecanica.md).

Correção complementar: a barreira corporal do passador permanece na recepção automática por0,35s após o contato, mesmo com bola livre. A margem inclui bola debaixo dos pés contra aproximação traseira, preservando interceptação frontal. A regressão verifica o percurso depois de lançar:109 testes e cenário visual forward-pass passam.
